...
const replaceWords = (str) => {
    let newString = str.split(' ');
        ...
        if (newString.indexOf("was")!=-1){
            newString[newString.indexOf("I")]="We";
            newString[newString.indexOf("was")]="were";
        }
        else if(newString.indexOf("am")!=-1){
            newString[newString.indexOf("I")]="We";
            newString[newString.indexOf("am")]="are";
        }
        else {
            newString[newString.indexOf("I")]="We";
        }
